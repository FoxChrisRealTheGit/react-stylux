...
var TallRectangleImage = function (_Component) {
    ...
    _createClass(TallRectangleImage, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('img', { style: image, id: this.state.id, className: 'tallrecimg-' + this.state.size + ' ' + this.state.className, src: this.state.childs[0], alt: this.state.childs[1] });
        }
    }]);
