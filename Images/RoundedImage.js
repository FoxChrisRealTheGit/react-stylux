...
var RoundedImage = function (_Component) {
    ...
    _createClass(RoundedImage, [{
        ...
        value: function render() {
            ...
            var ROUNDEDIMG = _nestingstyles2.default.create({
                roundedimg: {
                    borderRadius: '30%',
            ...
            return _react2.default.createElement(
                Fragment,
                null,
                _react2.default.createElement('img', { style: ROUNDEDIMG.roundedimg, id: this.state.id, className: 'img-' + this.state.size + ' ' + this.state.className, src: this.state.childs[0], alt: this.state.childs[1],
                    onMouseEnter: function onMouseEnter() {
                        return _this2.setState({ color: ROUNDEDIMG.hoverStyle.color });
                    },
